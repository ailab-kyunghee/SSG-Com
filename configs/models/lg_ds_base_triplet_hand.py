...
train_evaluator = dict(
    ...
    ann_file=os.path.join(_base_.data_root, 'train/annotation_ds_coco_triplet.json'),
...
val_evaluator = dict(
    ...
    ann_file=os.path.join(_base_.data_root, 'val/annotation_ds_coco_triplet.json'),
    use_pred_boxes_recon=True,
    metric=[],
    num_classes=28,
...
test_evaluator = dict(
    ...
    ann_file=os.path.join(_base_.data_root, 'test/annotation_ds_coco_triplet.json'),
    metric=[],
    num_classes=28,
