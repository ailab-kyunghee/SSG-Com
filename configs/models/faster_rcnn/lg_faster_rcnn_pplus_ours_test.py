...
train_dataloader =dict(batch_size=1,dataset=dict(ann_file='train/train_endo_with_tri_annotations_coco.json',data_prefix=dict(img='train/') ))
train_eval_dataloader =dict(batch_size=1,dataset=dict(ann_file='train/train_endo_with_tri_annotations_coco.json',data_prefix=dict(img='train/') ))
