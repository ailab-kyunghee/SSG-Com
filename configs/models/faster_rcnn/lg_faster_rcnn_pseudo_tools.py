...
detector.test_cfg.rcnn.max_per_img = 8
...
model.graph_head.type='GraphHead_pseudo'
del _base_.lg_model
...
train_dataloader =dict(dataset=dict(ann_file='train/train_annotations_coco_tools.json'))
train_eval_dataloader =dict(dataset=dict(ann_file='train/train_annotations_coco_tools.json'))
val_dataloader =dict(dataset=dict(ann_file='val/val_annotations_coco_tools.json'))
test_dataloader =dict(dataset=dict(ann_file='test/test_annotations_coco_tools.json'))
val_evaluator = dict(ann_file='/local_datasets/endoscapes/val/val_annotations_coco_tools.json')
test_evaluator = dict(ann_file='/local_datasets/endoscapes/test/test_annotations_coco_tools.json')
