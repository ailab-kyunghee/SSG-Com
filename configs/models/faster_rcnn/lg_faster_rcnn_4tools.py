...
train_dataloader =dict(dataset=dict(ann_file='train/train_annotations_coco_tools_4tools.json'))
train_eval_dataloader =dict(dataset=dict(ann_file='train/train_annotations_coco_tools_4tools.json'))
val_dataloader =dict(dataset=dict(ann_file='val/val_annotations_coco_tools_4tools.json'))
test_dataloader =dict(dataset=dict(ann_file='test/test_annotations_coco_tools_4tools.json'))
val_evaluator = dict(ann_file='/local_datasets/endoscapes/val/val_annotations_coco_tools_4tools.json')
test_evaluator = dict(ann_file='/local_datasets/endoscapes/test/test_annotations_coco_tools_4tools.json')