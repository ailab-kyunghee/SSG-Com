...
train_dataloader =dict(dataset=dict(ann_file='train/ds_triplet_train_pplus_annotations_coco_final_tight.json'))
train_eval_dataloader =dict(dataset=dict(ann_file='train/ds_triplet_train_pplus_annotations_coco_final_tight.json'))
val_dataloader =dict(dataset=dict(ann_file='val/ds_triplet_val_pplus_annotations_coco_final_tight.json'))
test_dataloader =dict(dataset=dict(ann_file='test/ds_triplet_test_pplus_annotations_coco_final_tight.json'))
train_evaluator = dict(ann_file='/local_datasets/endoscapes/train/ds_triplet_train_pplus_annotations_coco_final_tight.json', num_classes=28,)
val_evaluator = dict(ann_file='/local_datasets/endoscapes/val/ds_triplet_val_pplus_annotations_coco_final_tight.json', num_classes=28,)
test_evaluator = dict(ann_file='/local_datasets/endoscapes/test/ds_triplet_test_pplus_annotations_coco_final_tight.json', num_classes=28,)