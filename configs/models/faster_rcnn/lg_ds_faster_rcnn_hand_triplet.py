...
val_evaluator = dict(ann_file='/local_datasets/endoscapes/val/ds_triplet_val_pplus_annotations_coco_final_tight.json')
test_evaluator = dict(ann_file='/local_datasets/endoscapes/test/ds_triplet_test_pplus_annotations_coco_final_tight.json')