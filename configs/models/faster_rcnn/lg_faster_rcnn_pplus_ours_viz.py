...
model.graph_head.type='GraphHead_null_node'
del _base_.lg_model
...
model.graph_head.triplet_loss_weight=0.6
model.graph_head.hand_loss_weight=0.001
...
# val_dataloader =dict(dataset=dict(ann_file='val/val_endo_sg201_annotations_cocopseudo_top_350.json'))
# test_dataloader =dict(dataset=dict(ann_file='test/test_endo_sg201_annotations_coco_pseudo_top_350.json'))
# val_evaluator = dict(ann_file='/local_datasets/endoscapes/val/val_endo_sg201_annotations_cocopseudo_top_350.json')
