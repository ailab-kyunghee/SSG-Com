...
train_dataloader =dict(dataset=dict(ann_file='train/ds_triplet_train_annotations_full.json'))
train_eval_dataloader =dict(dataset=dict(ann_file='train/ds_triplet_train_annotations_full.json'))
val_dataloader =dict(dataset=dict(ann_file='val/ds_triplet_val_annotations_full.json'))
test_dataloader =dict(dataset=dict(ann_file='test/ds_triplet_test_annotations_full.json'))
train_evaluator = dict(ann_file='/local_datasets/endoscapes/train/ds_triplet_train_annotations_full.json', num_classes=34,)
val_evaluator = dict(ann_file='/local_datasets/endoscapes/val/ds_triplet_val_annotations_full.json', num_classes=34,)
test_evaluator = dict(ann_file='/local_datasets/endoscapes/test/ds_triplet_test_annotations_full.json', num_classes=34,)