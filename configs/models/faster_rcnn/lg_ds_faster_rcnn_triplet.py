...
train_evaluator = dict(ann_file='/local_datasets/endoscapes/val/ds_triplet_train_annotations_full.json')
val_evaluator = dict(ann_file='/local_datasets/endoscapes/val/ds_triplet_val_annotations_full.json')
test_evaluator = dict(ann_file='/local_datasets/endoscapes/test/ds_triplet_test_annotations_full.json')