...
model.graph_head.type='GraphHead_hand'
del _base_.lg_model
...
train_dataloader =dict(dataset=dict(ann_file='train/train_oper_annotations_coco.json'))
train_eval_dataloader =dict(dataset=dict(ann_file='train/train_oper_annotations_coco.json'))
val_dataloader =dict(dataset=dict(ann_file='val/val_oper_annotations_coco.json'))
test_dataloader =dict(dataset=dict(ann_file='test/test_oper_annotations_coco.json'))

val_evaluator = dict(ann_file='/local_datasets/endoscapes/val/val_oper_annotations_coco.json')
test_evaluator = dict(ann_file='/local_datasets/endoscapes/test/test_oper_annotations_coco.json')
