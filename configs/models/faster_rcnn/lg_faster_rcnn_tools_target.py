...
train_dataloader =dict(dataset=dict(ann_file='train/train_annotations_coco_tools_and_target_updated.json'))
train_eval_dataloader =dict(dataset=dict(ann_file='train/train_annotations_coco_tools_and_target_updated.json'))
val_dataloader =dict(dataset=dict(ann_file='val/val_annotations_coco_tools_and_target_updated.json'))
test_dataloader =dict(dataset=dict(ann_file='test/test_annotations_coco_tools_and_target_updated.json'))
val_evaluator = dict(ann_file='/local_datasets/endoscapes/val/val_annotations_coco_tools_and_target_updated.json')
test_evaluator = dict(ann_file='/local_datasets/endoscapes/test/test_annotations_coco_tools_and_target_updated.json')
