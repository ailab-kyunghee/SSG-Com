...
These missing elements are crucial for context-aware modeling in surgical workflows:contentReference[oaicite:1]{index=1}.
...
*SSG-Com consistently outperforms prior methods, especially when incorporating hand identity:contentReference[oaicite:4]{index=4}.*
...
*Figure 3: Comparison of graphs generated by LG-CVS vs. SSG-Com. Our method captures both action relations and hand identity, leading to more contextually rich representations:contentReference[oaicite:5]{index=5}.*
...
- **Improved performance** on both **triplet recognition** and **CVS assessment**, surpassing state-of-the-art baselines:contentReference[oaicite:6]{index=6}.
